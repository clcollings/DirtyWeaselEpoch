...
_ndGen = true;//Require a Generator ? An entity, set by _genCls, must be within a radius (in metres), set by_rngGen, for the towerlights to be lit.
_rngGen = 200;//Generator range (Generator must be within this radius from the tower for towerlights to be lit)
_genCls = "PowerGenerator";//Class name of generator (TEsted PowerGenerator_EP1 & PowerGenerator)
//End Edit Values
