...
SAR_HUMANITY_HOSTILE_LIMIT = -100;
...
KRON_UPS_closeenough = 175; // if you have vast plain areas, increase this to sth around 150-300 
...
SAR_heli_type=["UH1H_DZ","Mi17_DZ","CH_47F_EP1_DZ"];