...
DefaultMagazines = ["ItemBandage","ItemBandage","7Rnd_45ACP_1911","ItemPainkiller","ItemMorphine","30Rnd_545x39_AK"]; 
DefaultWeapons = ["Colt1911","AKS_74_U","ItemFlashlightRed","Binocular","ItemKnife","ItemMap"]; 
...
[] ExecVM "map_updates\altar.sqf";													            // Altar FOB
[] ExecVM "map_updates\devilscastle.sqf";														// Devils Castle Base
[] ExecVM "map_updates\bridge.sqf";																// Skalisty Bridge 
[] ExecVM "map_updates\endurance.sqf";															// Surv. Base
[] ExecVM "map_updates\milsouth.sqf";															// Southcoast FOB
[] ExecVM "map_updates\milnorth.sqf";															// Eastcoast FOB
[] ExecVM "map_updates\range.sqf";																//Target Range
[] ExecVM "map_updates\NWAF.sqf";																//NWAF
